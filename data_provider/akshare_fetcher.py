...
# Akshare's stock_cyq_em relies on embedded JS runtime (py-mini-racer).
# It is not thread-safe on macOS; concurrent calls can crash the process.
...
class AkshareFetcher(BaseFetcher):
    ...
    def get_chip_distribution(self, stock_code: str) -> Optional[ChipDistribution]:
        ...
        try:
            ...
            # Guard against concurrent V8 initialization in py-mini-racer (macOS crash).
