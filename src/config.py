...
class Config:
    ...
    openai_use_responses: bool = True  # Prefer OpenAI Responses API over Chat Completions when using OpenAI-compatible models
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            openai_use_responses=parse_env_bool(os.getenv('OPENAI_USE_RESPONSES'), default=True),
